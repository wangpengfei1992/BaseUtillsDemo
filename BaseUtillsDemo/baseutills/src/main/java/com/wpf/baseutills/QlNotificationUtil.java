...
//        channel.setVibrationPattern(new long[]{1000, 2000, 1000,3000});
    ...
    public static void show(Context context, int largeIcon,
        ...
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), largeIcon == 0 ? R.drawable.ic_push_notify : largeIcon)) // 设置自动收报机和通知中显示的大图标。
                .setSmallIcon(smallIcon == 0 ? R.drawable.ic_push_notify : smallIcon) // 小图标
...
//                .setContent(RemoteViews RemoteView)// 设置自定义通知栏
                .setColor(ContextCompat.getColor(context, R.color.brandColor))
